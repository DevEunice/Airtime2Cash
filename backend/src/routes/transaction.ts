...
import { adminAuth, auth, secondAuth } from '../middleware/auth';
const router = Router();
...
router.patch('/confirm/:id', auth, adminAuth, secondAuth, confirmTransaction)
router.patch('/cancel/:id', auth, adminAuth, secondAuth, cancelTransaction)
